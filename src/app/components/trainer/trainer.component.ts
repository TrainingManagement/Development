...
export class TrainerComponent extends BaseApp implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    this.trainerForm = this.formBuilder.group({
      trainingName: ["", [Validators.required, Validators.maxLength(70), CustomValidators.cannotContainSpace]],
      trainingType: ["", [Validators.required, CustomValidators.cannotContainSpace]],
      startDate: [''],
      startTime: [''],
      endTime: [''],
      completionStatus: ['']
